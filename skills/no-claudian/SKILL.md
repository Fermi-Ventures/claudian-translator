...
5. Hand the user the finished document. Report in a sentence or two what changed (how many sentences, the shapes that recurred) and ask about anything you still need to know. The table and the JSON are yours to read, not theirs. Show them only if asked.
